      ...
      <div class="min-h-screen flex flex-col items-center justify-center py-6 px-4">
        <div class="max-w-md w-full">
          ...
          <div class="p-8 rounded-2xl bg-white shadow">
            ...
            <form id="loginform" autocomplete="off" class="mt-8 space-y-4" method="post" action="#">
            <p class="error-text px-4 py-2 bg-red-50 hidden font-bold text-red-500 text-lg"></p>  
              <div class="">
                ...
                <div class="relative flex items-center">
                  <input name="username" type="text" required class="w-full text-gray-800 text-sm border border-gray-300 px-4 py-3 rounded-md outline-blue-600" placeholder="Nhập tên người dùng.." />
              ...
              <p class="text-gray-800 text-sm !mt-8 text-center">Bạn Chưa có tài khoản? <a href="/website/register.php" class="text-blue-600 hover:underline ml-1 whitespace-nowrap font-semibold">Đăng kí ở đây</a></p>
            </form>
          </div>
        </div>
      </div>
